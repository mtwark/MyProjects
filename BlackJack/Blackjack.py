...
class Blackjack:
    ...
    def __init__(self, number_of_players, cards_in_deck, neural_net):
    ...
    def print_dealer_hand(players, start_index):
        ...
        if start_index == 0:
            ...
            if ace:
                print("Sum:", players[1].lower_score - players[1].cards[0].val, "or",
                      players[1].upper_score - players[1].cards[0].val)
            else:
    ...
    def get_training_data(number_of_players, iterations):
        ...
        for i in range(iterations):
            ...
            if peek_top_card(deck).val + players[0].upper_score <= 21:
                hit = 1
            elif peek_top_card(deck).val + players[0].lower_score <= 21 and peek_top_card(deck).val + players[
                0].lower_score >= players[0].upper_score:
                hit = 1
            row += [hit]
            data += [row]
